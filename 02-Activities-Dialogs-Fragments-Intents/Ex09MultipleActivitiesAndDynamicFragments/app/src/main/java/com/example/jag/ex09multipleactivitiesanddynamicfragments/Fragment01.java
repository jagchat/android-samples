...
public class Fragment01 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnShow = (Button) v.findViewById(R.id.fragment01_btnShow);
        txtMsg = (EditText) v.findViewById(R.id.fragment01_txtMsg);
        btnShow.setOnClickListener(btnShowOnClick);
        return v;
    }

    private View.OnClickListener btnShowOnClick = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Toast.makeText(getActivity(), txtMsg.getText(), Toast.LENGTH_LONG).show();
        }
    };
